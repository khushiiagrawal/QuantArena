    ...
    const cards = [
        {
            ...
            what: `Governance policies focus on the systems and processes that ensure an organization is managed responsibly and efficiently. These policies establish a clear structure for decision-making, accountabilityand ethical behaviour at all levels. On the other hand, compliance policies are designed to ensure that an organization adheres to all applicable laws, regulationsand internal standards. They aim to prevent violations, reduce risksand promote a culture of lawful and ethical behaviour.`,
            ...
            ex: `- Corporate Governance Policy\n- Code of Conduct and Ethics Policy\n- Conflict of Interest Policy\n- Whistleblower Protection Policy\n- Anti-Corruption and Bribery Policy\n- Records Retention Policy\n- Regulatory Compliance Policy\n- Legal and Contract Management Policy\n- Intellectual Property Policy`,
        },
        {
            title: "Human Resources (HR) Policies",
            what: `Human resources (HR) policies are formal guidelines, rulesand procedures established by an organization to manage and regulate employee-related activities and ensure consistency, fairnessand compliance with legal requirements. These policies serve as a framework for addressing workplace practices, employee behaviour, compensation, developmentand relations between employees and the organization.`,
            why: `HR policies are essential tools that guide how an organization manages its workforce, ensuring operational efficiency, complianceand a transparent & positive workplace culture. They standardize decision-making and treatment of employees, reduce the risk of non-compliance with labour laws, build morale by fostering a supportive environment, minimize workplace disputes through clear guidelines etc.\n`,
        ...
        },
        {
            ...
            what: `Information technology (IT) policies are set of guidelines and procedures that govern the use, managementand security of an organization’s IT infrastructure, systemsand data. These policies outline the expectations, responsibilitiesand acceptable use of IT resources by employees, contractorsand other stakeholders within the organization`,
            why: `IT policies are essential for organizations to manage their technology assets responsibly, protect sensitive informationand ensure compliance with legal and regulatory frameworks. By implementing and enforcing comprehensive IT policies, organizations can create a secure and efficient technology environment.`,
        ...
        },
        {
            ...
            what:`Data and analytics policies are guidelines and procedures that govern the collection, management, use,analysis and protection of data within an organization. They ensure that data is handled in a way that aligns with legal, regulatoryand ethical standards while maximizing its value for decision-making and business operations.`,
            why:`Data and analytics policies are essential for organizations to manage their data assets responsibly, ensure complianceand leverage data effectively for strategic advantage. These policies ensure reliable data for decision-making while protecting sensitive information and builds trust with stakeholders. They also streamline data management and analytics processes.`,
        ...
        },
        {
            ...
            why:`Financial policies are essential for maintaining an organization's financial health and integrity. Implementing sound financial policies helps in managing organization’s financial resources, maintaining transparency achieve their financial goals responsibly and sustainably.`,
            ex:`- Budgeting and Financial Planning Policy\n- Expense Reimbursement Policy\n- Procurement and Purchasing Policy\n- Vendor and Supplier Management Policy\n- Fraud Detection and Prevention Policy\n- Accounts Payable and Receivable Policy\n- Investment and Asset Management Policy\n- Internal Auditing and Controls Policy`,
        ...
        },
        {
            ...
            what:`Marketing and communications policies are a set a guidelines and procedures that govern the organization’s marketing strategies, public relationsand internal and external communications. They help ensure that all marketing and communications activities are aligned with the organization’s values, goals and legal requirements.`,
            why:`Marketing and communications policies provide the necessary framework to ensure that all marketing and communications activities are aligned with the organization's mission, valuesand legal requirements. They help maintain consistency, protect the brand's reputationand foster ethical, transparent communication with customers and stakeholders.`,
            ex:`- Social Media Usage Policy\n- Advertising and Branding Policy\n- Customer Privacy Policy\n- Public Relations and Media Policy\n- Email Marketing and Communications Policy \n- Content Management Policy`,
        ...
        <div className="bg-[#D2D2D2] min-h-screen flex flex-col font-montserrat overflow-x-hidden">
            <div className="bg-[#9E6AED] px-4 py-4">
                <div className="text-medium font-montserrat text-white font-normal mt-20 px-12 text-left">
                    Services {">"} Analytics {">"} Enterprise Policy Development
                </div>
            ...
            <div className="flex-1">
                <div className="grid grid-cols-4 gap-4 px-2 md:px-6 lg:px-16 py-6">
                    {/* Column Headings */}
                    <React.Fragment>
                        <div className="bg-white p-4 md:p-6 rounded-lg shadow-md text-center">
                            <h3 className="text-base md:text-xl text-black font-semibold break-words">Types of Policies</h3>
                        </div>
                        <div className="bg-white p-4 md:p-6 rounded-lg shadow-md text-center">
                            <h3 className="text-base md:text-xl text-black font-bold break-words">What are these?</h3>
                        </div>
                        <div className="bg-white p-4 md:p-6 rounded-lg shadow-md text-center">
                            <h3 className="text-base md:text-xl text-black font-bold break-words">Why are these important?</h3>
                        </div>
                        <div className="bg-white p-4 md:p-6 rounded-lg shadow-md text-center">
                            <h3 className="text-base md:text-xl text-black font-bold break-words">Example of Policies</h3>
                        </div>
                    </React.Fragment>
                    {/* Card Content */}
