                ...
                <div className="relative z-10 mt-8 max-w-8xl mx-auto px-2 md:px-8">
                    ...
                    <div className="flex flex-col items-center md:flex-row md:items-center gap-8 mb-8">
                        <div className="relative w-full mt-10 md:w-1/2 px-4 md:px-6">
                            <div className="relative">
                                ...
                                />
                                <div
                                    className="absolute inset-0 transform -translate-x-4 md:-translate-x-6 translate-y-4 md:translate-y-6 -z-10"
                        ...
                        <div className="flex-1 text-center md:text-left mt-8 max-w-prose px-4 md:px-6">
                            ...
                            <p className="text-base md:text-lg leading-relaxed text-gray-800" style={fontStyle}>
                                Weather you are an individual, a sole proprietorship, a start-up,
                                 a large corporate or any organization including Government bodies,
                                  ...
                                  risk areas are to be identified, assessed and mitigated on an ongoing
                                   basis in order to run your process or business smoothly and efficiently.
                                    With our data-driven decision making, meaningful and efficient risk management
                    ...
                    <div className="flex flex-col items-center md:flex-row-reverse md:items-center gap-8 mb-8">
                        ...
                        <div className="flex-1 text-center md:text-left mt-8 max-w-prose px-4 md:px-6">
                            ...
                            <p className="text-base md:text-lg leading-relaxed text-gray-800" style={fontStyle}>
                            Our mission is to deliver cutting-edge analytics and risk management solutions 
                            that empower organizations to take the best possible decisions, identify, assess 
                            and mitigate risks with precision. We are committed to providing actionable insights, 
                            fostering data-driven decision-making and enabling businesses to enhance their 
                            resilience and long-term success in an ever-evolving landscape.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col items-center md:flex-row md:items-center gap-8">
                        ...
                        <div className="flex-1 text-center md:text-left mt-8 max-w-prose px-4 md:px-6">
                            ...
                            <p className="text-base md:text-lg leading-relaxed text-gray-800" style={fontStyle}>
                            Our expertise lies at the union of advanced analytics and efficient risk management.
                             We specialize in leveraging data-driven insights, predictive modeling and cutting-edge 
                             technologies to help organizations anticipate and mitigate risks across all sectors. 
                             Our team’s thorough research combined with a sophisticated understanding of risk dynamics
                              enables us to deliver tailored solutions that drive resilience, optimize performance and
                               safeguard against future uncertainties. With a focus on both short-term agility and 
                               long-term strategic growth, we empower our clients to navigate an increasingly complex 
