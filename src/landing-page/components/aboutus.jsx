        ...
        <div id='AboutUs'>
            ...
            {/* Purple Banner Background */}
                        ...
                        >
                            ...
                            <h1
                                className="absolute text-[85px] sm:text-[100px] md:text-[150px] lg:text-[250px] font-extrabold uppercase text-white opacity-10"
            ...
            {/* Content Section */}
            <div className="relative z-10 mt-12 max-w-7xl mx-auto px-4 md:px-12">
                {/* Vision Section */}
                <div className="flex flex-col items-center md:flex-row md:items-center gap-8 mb-16">
                ...
                {/* Mission Section */}
                <div className="flex flex-col items-center md:flex-row-reverse md:items-center gap-8 mb-16">
                    ...
                    <div className="flex-1 text-center md:text-left mt-24 max-w-prose px-4 md:px-6">
                        <h3 className="text-2xl md:text-3xl mb-6 text-black" style={fontStyle}>
                            Our Mission
                        </h3>
                        <p className="text-base md:text-lg leading-relaxed text-gray-800" style={fontStyle}>
