            ...
            {selectedMember && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white w-[70%] sm:w-[80%] lg:w-[90%] max-w-5xl p-8 shadow relative text-left overflow-y-auto max-h-[90vh]">
                        ...
                        <div className="text-gray-800 text-sm px-3 text-justify font-montserrat leading-relaxed space-y-4">
                            <p>{selectedMember.intro}</p>
                        </div>
                        <div className="w-full h-0.5 bg-gray-300 my-4"></div>
                        <h3 className="text-lg font-semibold font-montserrat text-gray-800 mb-2">Resume</h3>
                        <span className="flex items-center space-x-4">
                            
                            <span className='bg-[#9E6AED] w-40 text-center rounded py-1.5 px-1 text-white shadow'>{selectedMember.name}</span>
                            <a
                                href="/path/to/your/resume.pdf"
                                download="Resume.pdf"
                                className="text-[#824AD8] font-montserrat text-lg"
                            >
                        ...
                        <div className="mt-2">
                            <h4 className="text-medium font-montserrat text-[#5BD8A3] bg-[#5BD8A336] w-40 h-8 px-1 rounded py-1 mb-4">Social Media Links</h4>
                            ...
                            <div className="flex mt-4 space-x-3">
                                ...
                                >
                                    <img src={linkedin} alt="Linkedin" className='cursor-pointer w-10 h-10'/>
                                </a>
                                </span>
                                <span>
                                <a
                                    ...
                                    target="_blank" rel="noopener noreferrer"
                                >
                                    <img src={facebook} alt="Facebook" className='cursor-pointer w-10 h-10'/>
                                </a>
                                </span>
